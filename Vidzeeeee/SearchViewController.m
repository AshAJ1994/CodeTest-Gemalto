...
- (void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText {
    ...
    if (searchText.length > 0) {
        NSString *searchUrl = [NSString stringWithFormat: @"https://api.themoviedb.org/3/search/movie?api_key=%@&query=%@&&primary_release_year=%d&language=en-US",self.apiKey,searchText,2017];
